...
def ConstructTest():
    ...
    basem.PyAddPlayer_002(TpPlayerBase.PlayerBaseID,'Ayanami','UnInitedHardwareCode')

    TpPlayerBase = basem.PyAddPlayerBase('Aressions', '1919810','114514')
    basem.PyAddPlayer_002(TpPlayerBase.PlayerBaseID, 'Aression','UnInitedHardwareCode')